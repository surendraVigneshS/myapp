...
<head>
    ...
    <title>Tax | Freeztek | Accounts</title>
                    ...
                    <div class="row"> 
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 m-b-30">
                                            <a href="./tax-list.php?platform=<?php echo randomString(30) ?>&action=new"><button class="btn btn-primary f-right" type="button">Create New Tax</button> </a>
                                        </div>
                                    </div>
                                    <div class="table-responsive">
                                        <div class="table-responsive">
                                            <table class="display payment-table" id="">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $selectallowance = "SELECT * FROM `ft_tax` ORDER BY `tax_id` DESC ";
                                                    ...
                                                    if (mysqli_num_rows($executeallowance) > 0) {
                                                        while ($row = mysqli_fetch_array($executeallowance)) {
                                                            $deduction_id = $row['tax_id'];
                                                            $deduction = $row['tax_name'];
                                                    ?>
                                                            <tr>
                                                                <td><?php echo $slno; ?></td>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-body" id="addform">
                                    <form class="row g-3" method="POST" action="">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control border-end-0" id="taxName" name="taxName" value="">
								    	</div> 
                                        <div class="col-12">
											<div class="d-grid">
                                ...
                                <?php 
                                    $getallowance = mysqli_query($dbconnection,"SELECT * FROM `ft_tax` WHERE `tax_id` = '$fieldid'");
                                    if($rows = mysqli_fetch_array($getallowance)){
                                        $name = $rows['tax_name']; 
                                    }    
                                ?>
								<div class="text-center">
									<h6 class="">Edit Tax Details</h6>
								</div>
								<div class="form-body" id="addform">
                                    <form class="row g-3" method="POST" action="">
                                        ...
                                        <div class="col-12">
								    		<label for="taxName" class="form-label">Tax Name *</label>
                                            <input type="text" class="form-control border-end-0" id="taxName" name="taxName" value="<?php echo $name; ?>"  >
								    	</div> 
                                        <div class="col-12">
											<div class="d-grid">
												<button type="button" class="btn btn-primary" id="add_btn"><i class="bx bx-save"></i>Save</button>
