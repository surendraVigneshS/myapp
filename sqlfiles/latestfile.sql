...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2021 at 06:11 AM
...
(3, 1, 1, 'column 1', '61076822be360.png', 1),
(4, 1, 1, 'column 3', '6107685eb64e9.png', 1);
...
(1, 1, 'PIN/0001/21-22', 1, '2021-08-02', 1, 1, 1, 'dsafdsgfdgf', 1, '2021-08-02 01:52:44'),
(2, 3, 'PIN/0002/21-22', 2, '2021-08-02', 1, 22, 1, 'dafsfdgf', 1, '2021-08-02 02:33:12'),
(3, 2, 'PIN/0003/21-22', 3, '2021-08-02', 1, 0, 2, '', 1, '2021-08-02 09:39:10');
...
INSERT INTO `ft_po` (`po_id`, `po_pr_id`, `po_type`, `po_code`, `po_short_code`, `po_date`, `po_due_date`, `po_supplier_id`, `po_product_count`, `po_product_type`, `po_additions_amount`, `po_total_amount`, `po_final_amount`, `amount_in_words`, `po_transport_mode`, `po_transport_name`, `po_file`, `po_file_attachment`, `po_qr_code`, `po_remarks`, `po_created_by`, `po_updated_by`, `po_created_time`, `po_updated_time`, `po_terms`, `ft_bill_file`, `created_from`, `po_status`, `po_mail_sent`, `po_dc_entry`) VALUES
(1, NULL, 'Purchase Order', 'PO/0001/21-22', 1, '2021-08-02', NULL, 12, 1, 'Capital Goods', 560, 2000, 2560, 'Two Thousand Five Hundred Sixty   Rupees ', 'gjhb,m.', 'sfdxfbg', '10714122705645681_BAKER ALEXANDERSDAF.pdf', NULL, '6107015e53c37.png', '', 1, NULL, '2021-08-02 01:47:34', NULL, NULL, NULL, 1, 3, 0, 1),
(2, 9, 'Purchase Order', 'PO/0002/21-22', 2, '2021-08-02', NULL, 12, 1, 'Capital Goods', 0, 4950, 4950, 'Four Thousand Nine Hundred Fifty   Rupees ', ' ghhn', 'cghvhbn', NULL, NULL, '61070ba99ca65.png', '', 1, NULL, '2021-08-02 02:31:29', NULL, NULL, NULL, 2, 3, 0, 0),
(3, 9, 'Purchase Order', 'PO/0003/21-22', 3, '2021-08-02', NULL, 12, 1, 'Capital Goods', 0, 4950, 4950, 'Four Thousand Nine Hundred Fifty   Rupees ', ' ghhn', 'cghvhbn', '10714125515268411_BAKER ALEXANDERSDAF.pdf', NULL, '61070bd64b57e.png', '', 1, NULL, '2021-08-02 02:32:14', NULL, NULL, NULL, 2, 3, 0, 1);
...
(9, 'PUR-1386759', 'Vencar Admin ', '5', 12, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'Immediate', 'afdsgfdgfg', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 1, '2021-08-02 02:10:13', 0, 0, NULL, 0, 0, '2021-08-01 20:40:13', 0, 0, NULL, NULL, NULL, NULL, NULL, 1, '2021-08-01 20:40:13', 0, 1, 0, 0, 0, NULL, 0, 0, 0, 0, '06-08-2021', 1);
...
--
ALTER TABLE `ft_inward_details`
  MODIFY `pi_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `ft_po_add_details`
  MODIFY `po_add_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `ft_po_details`
  MODIFY `po_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
