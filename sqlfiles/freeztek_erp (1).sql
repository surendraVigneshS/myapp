...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2021 at 12:58 PM
...
(1, 'Yasir Kaufman', 'Exercitationem labor', 1, '60f9aa1f1c95a.png'),
(2, 'Cherokee Herring', 'Quae eum id et et q', 1, '60f9aa58eae28.png'),
(3, 'New Group', 'NG', 1, '60fe482701af3.png');
...
INSERT INTO `ft_po` (`po_id`, `po_type`, `po_code`, `po_short_code`, `po_date`, `po_due_date`, `po_supplier_id`, `po_product_count`, `po_product_type`, `po_additions_amount`, `po_total_amount`, `po_final_amount`, `amount_in_words`, `po_file`, `po_file_attachment`, `po_qr_code`, `po_remarks`, `po_created_by`, `po_created_time`, `po_terms`) VALUES
(1, 'Job Order', 'JO/0001/21-22', 1, '2021-07-01', '2021-06-29', 3, 1, 'Process Item', 18, 50, 50, 'Fifty   Rupees ', '10713523617656854_ANIKA OSBORN.pdf', NULL, '60fe493e028c7.png', 'fegrdfh', 1, '2021-07-26 11:03:49', 'sewafesghdgfmhg'),
(2, 'Purchase Order', 'PO/0002/21-22', 2, '2001-12-12', '1997-03-30', 6, 1, 'Capital Goods', 959.405, 52.25, 111.65, 'One Hundred  One Rupees  and Sixty Five paise', '10713527291737741_ERICA GUERRA.pdf', NULL, '60fe556fbce81.png', 'Checking Remarks', 1, '2021-07-26 11:55:51', 'akjd');
...
INSERT INTO `ft_po_details` (`po_details_id`, `po_id`, `po_product_id`, `po_product_name`, `po_product_qty`, `po_product_sub_amount`, `po_product_disc_per`, `po_product_disc_amount`, `po_product_final_amount`, `po_supplier_id`) VALUES
(1, 1, 2, 'Imelda French', 1, 500, 10, 450, 50, 3),
(2, 2, 2, 'Imelda French', 699, 55, 5, 2.75, 52.25, 6);
...
CREATE TABLE `supplier_details` (
  ...
  `supplier_ifsc_code` varchar(10) DEFAULT NULL,
...
(1, 'Althea Francis', NULL, 'vusus@mailinator.com', 'Duis odio ', NULL, 'Alias non id quasi e', 'Animi et c', NULL, NULL, NULL),
(2, 'Chadwick Mckay', NULL, 'henuvunaqy@mailinator.com', 'Natus nequ', NULL, 'Sit ea id est labor', 'Et proiden', NULL, NULL, NULL),
(3, 'Anika Osborn', 'dasdasdasdsd', 'beryzij@mailinator.com', 'Reiciendis', NULL, 'Eiusmod et vero vero', 'Ratione nu', 'asdsadasdsd,asdas,', 'asdas', 'asdasd'),
(4, 'Zena Callahan', NULL, 'rogelosid@mailinator.com', 'Aut qui ex', NULL, 'Animi laboris beata', 'Architecto', NULL, NULL, NULL),
(5, 'Ronan Mccarthy', NULL, 'vesamoxody@mailinator.com', 'Delectus ', NULL, 'Eos modi reprehender', 'Dolorum ve', NULL, NULL, NULL),
(6, 'Erica Guerra', NULL, 'vomevazo@mailinator.com', 'Ut invento', NULL, 'Tempore ab laborios', 'Praesentiu', NULL, NULL, NULL),
(7, 'Jayme Estrada', NULL, 'zikafahu@mailinator.com', 'Perspiciat', NULL, 'Quia aut sint iusto ', 'Explicabo ', NULL, NULL, NULL),
(8, 'Miranda Ross', NULL, 'lytupix@mailinator.com', 'Veniam vo', NULL, 'Est et in unde id l', 'Ut ad repr', NULL, NULL, NULL),
(9, 'Kevyn Larsen', NULL, 'xypa@mailinator.com', 'Sed quia v', NULL, 'Amet velit sit sit ', 'Ut illum s', NULL, NULL, NULL),
(10, 'Willa Reynolds', NULL, 'zuxo@mailinator.com', 'Commodo do', NULL, 'Suscipit sit reprehe', 'Quaerat mo', NULL, NULL, NULL),
(11, 'Rama Garner', NULL, 'puracyfubu@mailinator.com', 'Corporis q', NULL, 'Mollitia fugiat sun', 'Est earum ', NULL, NULL, NULL),
(12, 'Xavier Stein', NULL, 'tujagygim@mailinator.com', 'Magnam at ', NULL, 'Dicta eius repellend', 'Voluptatum', NULL, NULL, NULL),
(13, 'Orlando Pollard', NULL, 'kexiwavipy@mailinator.com', 'Delectus ', NULL, 'Officiis at quidem e', 'Natus elig', NULL, NULL, NULL),
(14, 'Adria Mosley', NULL, 'tusa@mailinator.com', 'Doloremque', NULL, 'Sunt dolor amet om', 'Quia quia ', NULL, NULL, NULL),
(15, 'Clio Beach', NULL, 'xikiziki@mailinator.com', 'Ut qui est', NULL, 'Occaecat eum sit est', 'Dolorum au', NULL, NULL, NULL),
(17, 'Leigh Compton', NULL, 'roqopyqa@mailinator.com', 'Sunt quis ', NULL, 'Laborum Ut quis ali', 'Ipsum ut a', NULL, NULL, NULL);
...
--
ALTER TABLE `ft_po_add_details`
  MODIFY `po_add_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `ft_po_details`
--
ALTER TABLE `ft_po_details`
  MODIFY `po_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `purchase_request`
  MODIFY `pur_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
