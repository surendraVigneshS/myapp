...
<body>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3 ">
                                            <div class="col-6">
                                                ...
                                                <select class="form-select select2  productList" id="proId">
                                        ...
                                        <div class="row d-flex justify-content-end">
                                            <div class="col-4">
                                                ...
                                                <input class="form-control" type="text" id="discPercen" maxlength="3"  onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                            </div>
                                            <div class="col-4">
                                                <label class="col-form-label " for="discAmount">Discount Amount</label>
                                                <input class="form-control" type="text" id="discAmount"  onkeypress="return event.charCode >= 48 && event.charCode <= 57">
                                            </div>
                                            <div class="col-4">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-footer text-center ">
                                            <button class="btn btn-info" type="submit" name="addPurchaseOrder">Create New Purchase Order</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
    ...
    <script>
        ...
        $sale.on('input', () => {
            let disc = 0;
            var value = 0;
            let discamount = parseInt($sale.val());
