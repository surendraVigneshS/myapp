...
<head>
    ...
    <title>Item Group | Freeztek | Accounts</title>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 m-b-30">
                                            <a href="./item-group.php?platform=<?php echo RandomString(30) ?>&action=add"><button class="btn btn-primary f-right" type="button">Create New Item Group</button> </a>
                                        </div>
                                    </div>
