...
<head>
    ...
    <title>Rack | Freeztex | Accounts</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><?php if($action == 'add'){ echo 'Add Rack'; }if($action == 'edit'){ echo 'Edit Rack'; } ?></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h5><?php if($action == 'add'){ echo 'Add Rack'; }else if($action == 'edit'){
                                                echo 'Edit Rack';
                                            } ?></h5>
                                        </div>
                                        <div class="card-body"> 
                                            <?php if($action == 'add'){ ?>
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-4 col-form-label" for="status">Rack Name</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-4 col-form-label" for="storename">Rack Status</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="card-footer text-center mt-2">
                                                    <button class="btn btn-info" type="submit" name="addRack" >Add New Rack</button>
                                                </div>
                                            </form>
                                            <?php }else if($action == 'edit'){  
                                                $query = mysqli_query($dbconnection, "SELECT * FROM `ft_rack` WHERE `rack_id` = '$fieldid'");
                                                if (mysqli_num_rows($query) > 0) {
                                                    if($row = mysqli_fetch_array($query)){ 
                                                        $name = $row['rack_name'];
                                                        $status = $row['rack_status'];     
                                            ?>
                                            <form action="./include/_storeroom.php" method="POST">
                                                <input type="hidden" name="id" id="id" value="<?php echo $fieldid; ?>"> 
                                                <div class="mb-3 row">
                                                    <label class="col-sm-4 col-form-label" for="storename">rack Name</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-4 col-form-label" for="status">Rack status</label>
                                                    <div class="col-sm-8">
                                                ...
                                                <div class="card-footer text-center mt-2">
                                                    <button class="btn btn-info" type="submit" name="updateRack" id="updateRack">Save Changes</button>
                                                </div>
                                            </form>
                                            <?php } }else{ ?> 
