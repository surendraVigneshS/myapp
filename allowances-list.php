...
<head>
    ...
    <title>Allowances | Freeztek | Accounts</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">Additions</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row"> 
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12 m-b-30">
                                            <a href="./allowances-list.php?platform=<?php echo randomString(30) ?>&action=new"><button class="btn btn-primary f-right" type="button">Create New Additions</button> </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="display payment-table" id="">
                                                ...
                                                <tbody class="text-center">
                                                    <?php
                                                    $selectallowance = "SELECT * FROM `ft_allowances` ORDER BY `allowance_id` DESC ";
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><a onclick="addURL(this)" href="?platform=<?php echo randomString(45) ?>&action=edit&fieldname=<?php echo passwordEncryption($allowance_id) ?>" class="btn-primary btn-lg">Edit</a></td>
                                                            </tr>
                                                    <?php $slno++;
                                                        }
                                                    } ?>
						...
						<div class="card">
							<div class="card-body">
                                ...
                                <?php 
                                    $getallowance = mysqli_query($dbconnection,"SELECT * FROM `ft_allowances` WHERE `allowance_id` = '$fieldid'");
                                    if($rows = mysqli_fetch_array($getallowance)){
                                        $name = $rows['allowance']; 
                                    }    
                                ?>
								<div class="text-center">
									<h6 class="">Edit Additions Details</h6>
								</div>
								<div class="form-body" id="addform">
                                    <form class="row g-3" method="POST" action="">
                                        ...
                                        <div class="col-12">
								    		<label for="allowancename" class="form-label">Additions Name *</label>
