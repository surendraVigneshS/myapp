                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                          <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Beneficiary List</li>
                          </ol>
                        </div>
                    </div>
                </div>
                              ...
                              <table class="display payment-table" id="">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a href="./edit-beneficiary-details.php?platform=<?php echo randomString(45); ?>&action=editbeneficiary&fieldid=<?php echo passwordEncryption($beneficiaryid) ?>" class="btn btn-primary btn-xs" type="button">Edit</a>
                                    </td>
                                  </tr>
                                  <?php } } ?>
                                </tbody>
