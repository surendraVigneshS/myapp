<div class="card-body">
    <form action="./include/_purchaseController.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="hidden" name="purchaseAgainst" value="1"> 
        <div class="mb-3 row">
        ...
        <hr class="mt-4 mb-4">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-9">
                    <input class="form-control" id="totalAmount" name="totalAmount" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="9" value="<?php echo $row['total_amount']; ?>"  required> 
                    </div>
                </div>
 

                <?php if(!empty($row['bill_no'])){?>
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label" for="">Bill Details</label>
                        <div class="col-sm-4"> 
                            <input class="form-control" type="text" id="billNO"    name="billNO" value="<?php echo $row['bill_no']; ?>"   >
                        </div> 
                    <div class="col-sm-5"> 
                        <a href="<?php echo $uploadedPO.$row['bill_file']; ?>"  target="_blank"> 
                        <button type="button" class="btn btn-info" ><i class="feather icon-eye mr-2"></i> View Uploaded Bill Copy </button> </a>
                    </div> 
                </div>   
                <?php }   ?>
                <div class="mb-3 row">
                    <label class="col-sm-3 col-form-label">Change Bill copy</label>
                    <div class="col-sm-9">
        ...
        <div class="text-center">
            <button class="btn btn-primary" name="editPurchaseAlready" id="editPurchaseAlready" type="submit">Update Changes</button> 
        </div>
    </form>
</div>