                              ...
                              <table class="display payment-table" id="">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a href="./edit-supplier.php?platform=<?php echo randomString(45); ?>&action=editsupplier&fieldid=<?php echo passwordEncryption($beneficiaryid) ?>" class="btn btn-primary btn-xs" type="button">Edit</a>
                                    </td>
                                  </tr>
                                  <?php } } ?>
                                </tbody>
