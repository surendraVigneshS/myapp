...
<body>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-4 row">
                                            ...
                                            <div class="col-4">
                                                ...
                                                <input type="text" id="datepicker1" class="form-control" name="poDate" required>
                                            </div>
                                            <div class="col-4">
                                                <label class="col-form-label" for="poDueDate">PO Due Date</label>
                                                <input type="text" id="datepicker2" class="form-control" name="poDueDate">
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-12">
    ...
    <script>
        ...
        const $proamount = $('#proAmount'),
              ...
              $prodfinal = $('#proFinalAmount');

              let discountamount=0;

              $proamount.on('keyup', function(){
                 if($proamount.val().length){
                    $prodfinal.val($proqty.val() * parseFloat($proamount.val())); 
                 }
                    var sale  = $prodfinal.val();
                 if($prodisc.val().length){ 
                      sale = calculateSale(sale, $prodisc.val());
                 }
                 $prodfinal.val(sale);
              });

              $prodisc.on('keyup', function(){
                var sale  = parseFloat($proamount.val()) * Number($proqty.val()); 
                if($prodisc.val().length){
                    discountamount  = calculateSale(sale , $prodisc.val()); 
                    $prodfinal.val(discountamount);
                    $discamount.val(parseFloat($proamount.val()) - discountamount);  
                }
                    // $prodfinal.val(discountamount);
               });

            //   $proqty.on('change', function(){ 
            //     let amount = $proamount.val(); 
            //     if($proqty.val().length){
        ...
        $(function() {
            ...
            $("#addRow").click(function() {
                ...
                var finalamount = Number(proqty) * Number($('#proFinalAmount').val());
            ...
            $("#addTaxRow").click(function() {
                ...
                if (taxType && taxName) {
                    ...
                    elem += '<td><input type="hidden" name="taxName[]" value="' + taxName + '"> <p>' + taxNameText + '</p> </td> ';
