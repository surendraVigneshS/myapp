...
if (localStorage.sidebarToggled == "close_icon") {
...
$toggle_nav_top.click(function () { 
    ...
    if (localStorage.sidebarToggled != 'close_icon') {
        localStorage.sidebarToggled = "close_icon";       
    } else {
        localStorage.sidebarToggled = "";
    }   
    
    $(window).trigger('overlay'); 
}); 
if ($nav.hasClass('close_icon')) {
    $header.addClass("close_icon", true);  
} else {
    $nav.removeClass("close_icon", false); 
    $header.removeClass("close_icon", false); 
}
